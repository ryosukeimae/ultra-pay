  ...
  <main> 
      ...
      <div class="sub_spec pc_inner inner">
        ...
        <table class="company_contents">
            ...
            <tr>
             ...
             <tr>
              <th>所在地</th>
              <td>東京都新宿区西新宿1-22-2 新宿サンエービル8F</td>
            </tr>            
             <tr>
              <th>事業者登録</th>
    ...
    <section class="sub_spec inner pc_inner">
      ...
      <div class="company_message">
        <h3 class="company_message_top">「働く」を、もっと「おかね」につなげる</h3>
        <p>ネオキャリア グループが掲げる、社会に対する約束 "mission"</p>
        <p>ー「ヒト」と「テクノロジー」で一人ひとりの価値ある未来を実現するー</p>
        <p>この約束を実現するための一つの手段として “株式会社ＵＬＴＲＡ” は生まれました。</p>
        <p>「働いて」ー「対価を受け取る」</p>
        <p>何気なく繰り返されていることですが、この中には”日々の生活" や “未来” といった「ヒト」の "価値観" が詰まっています。</p>
        <p>初めて貰うバイト代やお給料の喜びには、いつまでも忘れられない思い出があったり、憧れがあったりすると思います。</p>
        <p>そんなシーンをもっと多く、もっと嬉しいものにできるよう、私たちは「働く」の課題を「HR Tech」で、「おかね」の課題を「Fin Tech」で解決してまいります。</p>
        ...
        <p>「ともにえがくみらいを」</p>
        <p>「HR Tech」 x 「Fin Tech」で、一緒に未来をつくっていければ嬉しいです。</p>
