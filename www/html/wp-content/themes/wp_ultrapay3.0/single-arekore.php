        ...
        <article class="arekore_each_wrap">
          <div>
            ...
            <div class="arekore_each_header">
              <h1><?php the_title(); ?></h1>
              <div>
                <time class="arekore_time released" itemprop="datePublished" datetime="<?php the_time('Y-m-d'); ?>">
                  <?php the_time('Y/m/d'); ?>
                </time>

                <?php if(get_the_time('Y/m/d') != get_the_modified_date('Y/m/d')):?>
                  <time class="arekore_time modified" itemprop="dateModified" datetime="<?php the_modified_date('Y-m-d'); ?>">                  
